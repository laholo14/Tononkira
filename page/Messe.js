...
import TononyMesse from './TononyMesse';
let logo = require('../assets/icon.png');

export default function Messe({ navigation }) {
  const Alefa = (titre, contenu, refrain) => {
    navigation.navigate('AfficheTononyMesse', { titre: titre, contenu: contenu, refrain: refrain });
  }
  return (
      ...
      <Header style={styles.header}>
        ...
        <Body>
          <View style={styles.titleView}>
            ...
            <Subtitle style={styles.soustitre}>Messe Fiderana</Subtitle>
          </View>
        </Body>
        <Right>
